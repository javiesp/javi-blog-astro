...
Here are some rules/recommendations, tips & ticks for creating new posts in NSC blog theme.
...
> Prior to NSC v5.1.0, all blog posts had to be in `src/data/blog/`, meaning you couldn't organize them into subdirectories.

Starting from NSC v5.1.0, you can now organize blog posts into subdirectories, making it easier to manage your content.
...
Title and description (excerpt) are important for search engine optimization (SEO) and thus NSC encourages to include these in blog posts.
...
Here are some recommendations, tips & ticks for creating new posts in NSC blog theme.
...
There's one thing to note about headings. The NSC blog posts use title (title in the frontmatter) as the main heading of the post. Therefore, the rest of the heading in the post should be using h2 \~ h6.

This rule is not mandatory, but highly recommended for visual, accessibility and SEO purposes.

## Syntax Highlighting

NSC uses [Shiki](https://shiki.style/) as the default syntax highlighting. Starting from NSC v5.4, [@shikijs/transformers](https://shiki.style/packages/transformers) is used to enhance better fenced code blocks. If you don't want to use it, you can simply remove it like this
...
> Since NSC v1.4.0, OG images will be generated automatically if not specified. Check out [the announcement](https://astro-paper.pages.dev/posts/dynamic-og-image-generation-in-NSC-blog-posts/).
