...
tags:
  - release
description: "NSC Version 3: Elevating Your Web Experience with Astro v3 and Seamless View Transitions"
---

We're excited to announce the release of NSC v3, packed with new features, enhancements, and bug fixes to elevate your web development experience. Let's dive into the highlights of this release:

![NSC v3](@/assets/images/NSC-v3.png)
...
NSC now fully supports [Astro v3](https://astro.build/blog/astro-3/), offering improved performance and rendering speed.
...
`SITE.ogImage` is now optional. If it is not specified, NSC will automatically generate an OG image using `SITE.title`, `SITE.desc` and `SITE.website`
...
> This section is only for those who want to upgrade NSC v3 from the older versions.

This section will help you migrate from NSC v2 to NSC v3.

Before reading the rest of the section, you might also want to check [this article](https://astro-paper.pages.dev/posts/how-to-update-dependencies/) for upgrading dependencies and NSC.
...
**_Step 1: Replace everything else with NSC v3_**

In this step, replace everything\_ except above files/directories (plus your customized files/directories)\_ with NSC v3.
...
Actually, I've already written a blog post for this case and you can check out [here](https://astro-paper.pages.dev/posts/how-to-update-dependencies/#updating-NSC-using-git).

## Outro

Ready to explore the exciting new features and improvements in NSC v3? Start [using NSC](https://github.com/satnaing/astro-paper) now.
